...
import models.jdbc.GeoColumnExtensionMethods.GeoColumnExtensionMethodConversions
...
trait PostgisProfile extends PostgresProfile with GeoJdbcTypesComponent {
  ...
  override val api = new API with GeoImplicitColumnTypes with GeoColumnExtensionMethodConversions
}
